...
function transformFighterData(fighter) {
  return {
    ...
    sigStrLandedPerMin: fighter?.SigStrLandedPerMin ?? null,
    sigStrAbsorbedPerMin: fighter?.SigStrAbsorbedPerMin ?? null,
    sigStrikeAccuracyPct: fighter?.SigStrikeAccuracyPct ?? null,
    sigStrikeDefensePct: fighter?.SigStrikeDefensePct ?? null,
    takedownAvgPer15: fighter?.TakedownAvgPer15 ?? null,
    takedownAccuracyPct: fighter?.TakedownAccuracyPct ?? null,
    takedownDefensePct: fighter?.TakedownDefensePct ?? null,
    submissionAvgPer15: fighter?.SubmissionAvgPer15 ?? null,
    knockdownAvgPer15: fighter?.KnockdownAvgPer15 ?? null,
    averageFightTimeSeconds: fighter?.AverageFightTimeSeconds ?? null,
    recentForm: fighter?.RecentForm || null,
    lastFightDate: fighter?.LastFightDate || null,
  };
}
...
function buildFightResponse({
  ...
  const response = {
    ...
    fighter1_sig_str_landed_per_min: red.sigStrLandedPerMin,
    fighter1_sig_str_absorbed_per_min: red.sigStrAbsorbedPerMin,
    fighter1_sig_strike_accuracy_pct: red.sigStrikeAccuracyPct,
    fighter1_sig_strike_defense_pct: red.sigStrikeDefensePct,
    fighter1_takedown_avg_per_15: red.takedownAvgPer15,
    fighter1_takedown_accuracy_pct: red.takedownAccuracyPct,
    fighter1_takedown_defense_pct: red.takedownDefensePct,
    fighter1_submission_avg_per_15: red.submissionAvgPer15,
    fighter1_knockdown_avg_per_15: red.knockdownAvgPer15,
    fighter1_average_fight_time_seconds: red.averageFightTimeSeconds,
    fighter1_recent_form: red.recentForm,
    fighter1_last_fight_date: red.lastFightDate,
    fighter2_id: blue.id,
    ...
    fighter2_sig_str_landed_per_min: blue.sigStrLandedPerMin,
    fighter2_sig_str_absorbed_per_min: blue.sigStrAbsorbedPerMin,
    fighter2_sig_strike_accuracy_pct: blue.sigStrikeAccuracyPct,
    fighter2_sig_strike_defense_pct: blue.sigStrikeDefensePct,
    fighter2_takedown_avg_per_15: blue.takedownAvgPer15,
    fighter2_takedown_accuracy_pct: blue.takedownAccuracyPct,
    fighter2_takedown_defense_pct: blue.takedownDefensePct,
    fighter2_submission_avg_per_15: blue.submissionAvgPer15,
    fighter2_knockdown_avg_per_15: blue.knockdownAvgPer15,
    fighter2_average_fight_time_seconds: blue.averageFightTimeSeconds,
    fighter2_recent_form: blue.recentForm,
    fighter2_last_fight_date: blue.lastFightDate,
