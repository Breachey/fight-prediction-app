...
Scheduled discovery checks up to 80 event IDs with a 20-ID lookback, fetching at most four IDs concurrently and stopping after 15 consecutive misses. It has a ten-minute process limit and leaves optional poster lookup to card enrichment. Manual discovery retains its broader scan defaults. Timeout errors include the last discovery progress and endpoint errors.
